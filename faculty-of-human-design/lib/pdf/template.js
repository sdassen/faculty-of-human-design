...
<div style="width:210mm;height:297mm;background:#1A1715;position:relative;overflow:hidden;break-after:page;display:flex;flex-direction:column;align-items:center;">
  ...
  <div style="margin-top:108px;padding:0 30mm;text-align:center;">
    <div style="font-family:'Cormorant Garamond',serif;font-style:italic;font-weight:400;font-size:34pt;color:#FFFFFF;line-height:1.25;letter-spacing:-0.01em;">${esc(order.report_title || "Persoonlijk Rapport")}</div>
...
<div style="width:210mm;height:297mm;background:#F7F5F0;position:relative;overflow:hidden;break-after:page;padding:20mm;">
  ...
  <div style="font-family:'Cormorant Garamond',serif;font-style:italic;font-size:28pt;font-weight:400;color:#1A1715;margin-bottom:28px;line-height:1.1;">${esc(order.report_title || "")}</div>
  ${items}
